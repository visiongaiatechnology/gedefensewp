...
<section class="vgt-titan" aria-label="Styx Outbound Executioner">
    ...
    <?php if ($sync_result): ?>
        <div class="vis-dashboard-notice <?php echo ($sync_result['status'] ?? '') === 'success' ? 'is-success' : 'is-warning'; ?>" style="margin: 16px 0;" role="status">
    ...
    <!-- SECTION 3: THREAT INTELLIGENCE MATRIX (OPT-IN) -->
