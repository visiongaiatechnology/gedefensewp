...
```
git clone https://gitflic.ru/project/visiongaiatechnology/gedefensewp.git
cd gedefensewp
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/visiongaiatechnology/gedefensewp.git
git clone
